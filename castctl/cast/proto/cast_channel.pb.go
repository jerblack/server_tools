...
type CastMessage struct {
	...
	// They are used to route messages between endpoints that share a device-to-device channel.
	//
	...
	//
	// For messages to or from the sender or receiver platform, the special ids 'sender-0' and 'receiver-0' can be used.
	//
	// For messages intended for all endpoints using a given channel, the wildcard destination_id '*' can be used.
	...
	// All messages are sent on a namespace and endpoints sharing a channel listen on one or more namespaces.
	// The namespace defines the protocol and semantics of the message.
