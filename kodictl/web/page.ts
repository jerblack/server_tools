...
class BtnBox extends PartsBin {
    ...
    build():void {
        ...
        this._add_to(r1,
            ...
            RcBlank.make())
        this._add_to(r2,
            RcBtn.make(_.left, "left"),
            RcBtn.make("radio_button_checked", "select"),
            RcBtn.make(_.right, "right"))
        this._add_to(r3,
            RcBtn.make("arrow_back", "back"),
            RcBtn.make(_.down, "down"),
            RcBtn.make("clear", "delete"))
        this._add_to(r4,
            RcBtn.make("home", "home"),
            RcBtn.make("stop", "stop"),
            RcBtn.make("menu", "menu"))
